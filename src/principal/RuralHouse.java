...
public class RuralHouse {
	...
	/*public Offer createOffer(int offerNumber,Date firstDay, Date lastDay, float price)  {
        ...
        if (this.offers == null) this.offers = new Vector<Offer>();
        this.offers.add(off);
        return off;
	}*/
	public Offer createOffer(int idUsuario, int offerNumber,Date firstDay, Date lastDay, float price)  {
		System.out.println(offerNumber);
        Offer off=new Offer(idUsuario, offerNumber,firstDay,lastDay,price,this);
        if (this.offers == null) this.offers = new Vector<Offer>();
        this.offers.add(off);
        return off;
	}
	 ...
	 */
	public List<Offer> getOffersByDate( Date firstDay,  Date lastDay) {
