...
@FacesConverter("ruralHouseConverterQuery")

public class RuralHouseConverterQuery implements Converter {
	@Override
		...
		ValueExpression vex =
				arg0.getApplication().getExpressionFactory()
                        .createValueExpression(arg0.getELContext(),
                                "#{desplegable}", Desplegable.class);

		Desplegable houses = (Desplegable)vex.getValue(arg0.getELContext());
