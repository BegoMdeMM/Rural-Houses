...
@FacesConverter("ruralHouseConverterReserve")

public class RuralHousesConverterReserve implements Converter{
	@Override
		...
		ValueExpression vex =
				arg0.getApplication().getExpressionFactory()
                        .createValueExpression(arg0.getELContext(),
                                "#{reserveBean}", ReserveBean.class);

		ReserveBean houses = (ReserveBean)vex.getValue(arg0.getELContext());
